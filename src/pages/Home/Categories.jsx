                    ...
                    return (
                        <div className=' flex flex-col items-center justify-center gap-[30px]'>
                            ...
                            <div className='main_circle relative flex flex-col items-center justify-center'>
                                <div className=' circle  font-medium text-[16px] md:text-[20px] xl:text-[24px] px-[2px] z-20  w-[200px] h-[200px] md:w-[250px] md:h-[250px] xl:w-[300px] xl:h-[300px] flex flex-col gap-4 items-center justify-center text-center rounded-full bg-[#011B2B] shadow-category '>
                                    <AnimatedCounter targetNumber={item.value} />
                                    <h1 className=' text-[#FFFFFF]'>{item.name}</h1>
                                </div>

                                <div className=' z-0 -mt-[100px] md:-mt-[125px] xl:-mt-[150px] w-[240px] h-[120px] md:w-[300px] md:h-[150px]  xl:w-[350px] xl:h-[175px] rounded-b-full bg-[#011B2B]' />
                            </div>
